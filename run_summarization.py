...
class DataTrainingArguments:
    ...
    #src_lang: str = field(default=None, metadata={"help": "Language id for summarization."})
    #tgt_lang: str = field(default=None, metadata={"help": "Language id for summarization."})
    ...
    validation_file: Optional[str] = field(default=None, metadata={"help": "An optional input evaluation data file to evaluate the metrics (rouge) on "
    ...
    max_train_samples: Optional[int] = field(default=None, metadata={"help": "For debugging purposes or quicker training, truncate the number of training examples to this "
                                                                    "value if set."},)
    max_eval_samples: Optional[int] = field(default=None, metadata={"help": "For debugging purposes or quicker training, truncate the number of evaluation examples to this "
                                                                    "value if set."},)
    max_predict_samples: Optional[int] = field(default=None, metadata={"help": "For debugging purposes or quicker training, truncate the number of prediction examples to this "
                                                                        "value if set."},)
    num_beams: Optional[int] = field(default=4, metadata={"help": "Number of beams to use for evaluation. This argument will be passed to ``model.generate``, "
    ...
    source_prefix: Optional[str] = field(default="summarize: ", metadata={"help": "A prefix to add before every source text (useful for T5 models)."})
...
def main():
    ...
    if data_args.src_lang is not None:
        kwargs["language"] = {"src_lang": data_args.src_lang, "tgt_lang": data_args.tgt_lang}
