#!/bin/bash
#SBATCH --job-name=bt-m
#SBATCH --output=/hits/basement/nlp/fatimamh/outputs/bart/mono/out-%j 
#SBATCH --error=/hits/basement/nlp/fatimamh/outputs/bart/mono/err-%j
...
python run_summarization_no_trainer.py \
    ...
    --output_dir /hits/basement/nlp/fatimamh/outputs/bart/mono/ \
