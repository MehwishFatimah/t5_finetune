#!/bin/bash
#SBATCH --job-name=t5m
#SBATCH --output=/hits/basement/nlp/fatimamh/outputs/t5_summ/mono_exp/out-%j 
#SBATCH --error=/hits/basement/nlp/fatimamh/outputs/t5_summ/mono_exp/err-%j
...
python run_summarization_no_trainer.py \
    ...
    --output_dir /hits/basement/nlp/fatimamh/outputs/t5_summ/mono_exp/ \
